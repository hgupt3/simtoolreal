...
# The reusable study image predates the explicit parity variants. Advance only
# this study branch before installing/starting the worker service. A fast-forward
# merge preserves any unexpected image-side work instead of discarding it.
sudo -u tylerlum git -C /home/tylerlum/simtoolreal fetch \
  origin 2026-08-12_SimToolReal_Transformer_Study
sudo -u tylerlum git -C /home/tylerlum/simtoolreal checkout \
  2026-08-12_SimToolReal_Transformer_Study
sudo -u tylerlum git -C /home/tylerlum/simtoolreal merge --ff-only \
  origin/2026-08-12_SimToolReal_Transformer_Study
